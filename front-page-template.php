    ...
    <section class="services-section">
        <div class="container">
            ...
            <div class="services-grid">
                ...
                if (empty($services)) {
                    $services = array(
                        array('title' => 'Consulting', 'description' => 'Expert business consulting services', 'icon' => 'icon-briefcase'),
                        array('title' => 'Development', 'description' => 'Custom software development', 'icon' => 'icon-code'),
                        array('title' => 'Support', 'description' => '24/7 customer support', 'icon' => 'icon-support')
                    );
                }
            ...
            <div class="stats-grid">
                ...
                if (empty($stats)) {
                    $stats = array(
                        ...
                        array('number' => '50+', 'label' => 'Projects Completed'),
        ...
        <div class="container">
            ...
            <div class="testimonials-grid">
                ...
                if (empty($testimonials)) {
                    $testimonials = array(
                        array('content' => 'Excellent service and professional team. Highly recommended!', 'author' => 'John Doe', 'company' => 'ABC Corp'),
                        array('content' => 'They delivered exactly what we needed on time and within budget.', 'author' => 'Jane Smith', 'company' => 'XYZ Ltd')
                    );
                }
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="skills-list">
                        ...
                        if (empty($skills)) {
                            $skills = array(
                                array('name' => 'HTML/CSS', 'level' => '90'),
                                array('name' => 'JavaScript', 'level' => '85'),
                                array('name' => 'PHP', 'level' => '80'),
                                array('name' => 'WordPress', 'level' => '95'),
                                array('name' => 'Photoshop', 'level' => '75')
                            );
                        }
